...
//        : 은행 잔고를 창구를 통해서만 접근가능하도록
class Hong {
    String name = "홍길동"; //default : 같은 폴더 + 자신의 클래스 접근가능
    public int age = 20; //public : 모든폴더 + 상속관계 + 같은폴더 + 자신의 클래스
    protected int korScore = 80; //상속관계 + 같은폴더 + 자신의 클래스
    private int engScore = 90; //자신의 클래스에서만 접근 가능

...
class ApiControllerTest {
    ...
    @Autowired
    MockMvc mockMvc;
    @MockitoBean //API Controller 에서 주입받은 Bean객체에 대해서 Mock 형태로 객체 생성
    ...
    void loginAction() throws Exception {
        //given when
        //loginAction 함수가 제대로 동작하는 조건을 기술한다.
        ...
        //Jacson 라이브러리가 Springboot의 공식 라이브러리다.
        ...
        mockMvc.perform(post("/api/v1/loginAction")
                    .content(gson.toJson(dto))  //json 문자열을 Body에 실어 보낸다.
